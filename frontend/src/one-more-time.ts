/**
 * TODO - In future these common things should be moved to a common package
 * From https://github.com/bluerobotics/BlueOS/blob/master/core/frontend/src/one-more-time.ts
 */
